...
pub(crate) const CARGO_CONFIG_TOML: &str =
    include_str!("../../../assets/templates/.cargo/config.toml.j2");
...
// Блоки MCU (STM32F4)
pub(crate) const MCU_STM32F4_IMPORTS: &str =
    include_str!("../../../assets/templates/blocks/mcu/stm32f4/imports.rs.j2");
pub(crate) const MCU_STM32F4_INIT: &str =
...
pub(crate) const MCU_STM32F1_IMPORTS: &str =
    include_str!("../../../assets/templates/blocks/mcu/stm32f1/imports.rs.j2");
pub(crate) const MCU_STM32F1_INIT: &str =
...
pub(crate) const PERIPHERAL_W5500_IMPORTS: &str =
    include_str!("../../../assets/templates/blocks/peripherals/W5500/imports.rs.j2");
pub(crate) const PERIPHERAL_W5500_INIT: &str =
    include_str!("../../../assets/templates/blocks/peripherals/W5500/init.rs.j2");
pub(crate) const PERIPHERAL_W5500_LOGIC_SINGLE: &str =
    include_str!("../../../assets/templates/blocks/peripherals/W5500/logic_single.rs.j2");
pub(crate) const PERIPHERAL_W5500_LOGIC_BRIDGE: &str =
    include_str!("../../../assets/templates/blocks/peripherals/W5500/logic_bridge.rs.j2");
